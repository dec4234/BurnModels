...
impl CspDarknetConfig {
	...
	pub fn init<B: Backend>(&self, device: &B::Device) -> CspDarknet<B> {
		CspDarknet {
...
impl CspBlockConfig {
	pub fn new(in_channels: usize, out_channels: usize, depth: usize, spp: bool, depthwise: bool) -> Self {
	...
	pub fn init<B: Backend>(&self, device: &B::Device) -> CspBlock<B> {
		CspBlock {
